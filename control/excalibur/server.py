"""Excalibur ODIN server main functions.

This module implements the main entry point for the Excalibur ODIN server. It handles parsing
...
def main(argv=None):
    ...
    # Excalibur specific configuration options
    ...
    add_logger("excalibur_detector", {"level": config.access_logging, "propagate": True})
    setup_logging()
    ...
    logging.info('Launching Excalibur ODIN instance')
    ...
    logging.info('Excalibur ODIN server shutdown')
